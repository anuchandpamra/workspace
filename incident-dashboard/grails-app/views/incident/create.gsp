                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: incidentInstance, field: 'description', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="location"><g:message code="incident.location.label" default="Location" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: incidentInstance, field: 'location', 'errors')}">
                                    <g:select name="location.id" from="${incident.dashboard.Location.list()}" optionKey="id" value="${incidentInstance?.location?.id}"  />
                                </td>
                            </tr>
